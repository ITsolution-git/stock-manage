                            ...
                            $scope.SaveImageAll=function(image_array)
                            {
                                ...
                                $http.post('api/public/common/SaveImage',Image_data).success(function(result) {
                                    if(result.data.success=='1')
                                    {
                                        ...
                                        params.productColorSize[array_key][array_column_name] = result.data.records;
                                        params.productColorSize[array_key][array_column_name_url] = path+'api/public/uploads/'+image_path_url+'/'+result.data.records;                                             ;
                                        notifyService.notify("success", result.data.message);
                                        $mdDialog.hide();
                                    }
                                    else
            ...
            if (permission == true) {
                ...
                $http.post('api/public/common/deleteImage',order_main_data).success(function(result) {
                    ...
                    var data = {"status": "success", "message": "Image Deleted Successfully"}
                     ...
                     $scope.productColorSize[key][column_name] = '';
                     $scope.productColorSize[key][column_name_url] = '';
                });
            }
