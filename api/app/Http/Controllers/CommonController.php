...
*/
    ...
    public function __construct(Common $common, Company $company, Vendor $vendor, Purchase $purchase, Art $art, Client $client, Order $order, Machine $machine,Production $production) 
    {
        parent::__construct();
        $this->common = $common;
