...
*/
    ...
    public function getAffiliateData($data) {
        ...
        $listArray = ['a.name as affiliate_name','od.design_name','p.name as product_name','p.brand_name','p.product_image','o.note','o.id','o.affiliate_id','dp.design_id','p.id as product_id','p.company_id','p.vendor_id','o.affiliate_display_number as display_number'];
