...
*/  
    ...
    public function orderDetail($data) {
        ...
        $listArray = ['order.*','order.name as order_name','client.client_company','client.is_blind as client_blind','misc_type.value as approval','user.name as sales_name',
                      'users.name','cc.first_name as client_first_name','i.id as invoice_id','client.b_w_logo',
                      'cc.last_name as client_last_name','price_grid.name as price_grid_name','a.approval as art_approval','order.is_blind as order_blind'];
