          ...
          <table border="0" cellpadding="0" cellspacing="0" width="35%" align="center">
            <thead>
              <tr>
               @foreach ($data['order_item'] as $orderitem)
               <?php if($orderitem->selected == '1'){?>
               <th align="center" valign="top" width="23%">{{$orderitem->item}}</th>
               <th align="center" valign="top" width="2%">&nbsp;</th>
               <?php }?>
               @endforeach
               ...
               if(!in_array($data['order_misc']->position->$pos_id->value,$position_array)) {
                ...
                <th align="center" valign="top" width="23%">Print {{$data['order_misc']->position->$pos_id->value}}</th>
                <th align="center" valign="top" width="2%">&nbsp;</th>
                <?php }}
                $count++; ?>
                @endforeach
            ...
            <tbody>
              ...
              if(!in_array($data['order_misc']->position->$pos_id->value,$position_array_box)) {
               array_push($position_array_box, $data['order_misc']->position->$pos_id->value); 
               ?>
               <td align="center" valign="top" width="23%">
                <div class="prntBrdrBox"></div>
              </td>
