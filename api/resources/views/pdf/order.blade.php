      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          ...
          <td align="center" valign="top" width="25%" class="tableCol">
            ...
            <br/>
            <span>{{$data['company_detail'][0]->address}}, {{$data['company_detail'][0]->city}}, {{$data['company_detail'][0]->state}}, <br/>{{$data['company_detail'][0]->country}} - {{$data['company_detail'][0]->zip}}<br />{{$data['company_detail'][0]->url}}</span>
          </td>
