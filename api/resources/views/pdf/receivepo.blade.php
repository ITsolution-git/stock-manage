...
<body>
  ...
  <table style="font-weight:400;margin-top:20px;">
    ...
    <tr>
      <td>Account Manager : {{$company->account_manager}}</td>
          ...
          <hr style="border:1px solid #000;">
            ...
            {  
              ...
              <tr style="background-color:<?php echo $color_bg; ?>;" >
                  <td height="20" class="align-center line-height border-b" ><?php echo (!empty($value->brand_name))?$value->brand_name.' - ':''; ?><?php echo (!empty($value->product_name))?$value->product_name:''; ?><?php if($value->is_supply == 1){?><span style="color: #ff0000;font-size: 12px;font-weight: 600;">(Supplied)</span><?php }?></td>
