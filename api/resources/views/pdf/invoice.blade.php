...
<body style="padding:0; margin:0">
    <table width="530" align="left" cellspacing="5" cellpadding="0" style="font-size:10px;">
        <tr align="left" cellspacing="0" cellpadding="0">
            <td style="width:100%">
                <table width="100%" border="0" align="left" valign="top"  cellspacing="0" cellpadding="0" style="border-bottom:2px solid #000000; font-family: arial; font-size:11px;">
                    <tr>
                        <td width="30%" align="left" valign="top">
                                        <?php if(!empty($company_data[0]->photo))
                                        {?>
                                        <img src="{{$company_data[0]->photo}}" title="" alt="" align="left" width="100" height="100">
                                        <?php
                                        }
                                        else
                                        { ?>
                                            <img src="" title="" alt="" align="left" width="100" height="100">
                                        <?php
                                        }
                                        ?>
                        </td>
                        <td width="30%" align="left" style="font-size:13px; color:#00000; font-family: arial; line-height:13px; color:#000; font-size:10px; text-align:left;">
                            
                                   {{$company_data[0]->name}}<br>{{$company_data[0]->prime_address1}}<br>{{$company_data[0]->prime_address_city}}, {{$company_data[0]->prime_address_state}} {{$company_data[0]->prime_address_zip}}<br>{{$company_data[0]->phone}}<br>{{$company_data[0]->url}}
                        </td>
                        <td width="40%" style="padding:10px 0; vertical-align:top; text-align:right; font-weight:bold; text-transform:uppercase; font-size:10px;">Order Acknowledgement #{{$order_data[0]->id}}<br>Created On: {{$invoice_data[0]->created_date}}<br>Job Name: {{$order_data[0]->name}}</td>
                    </tr>
                   
                </table>
                <table width="100%" border="0" align="center" border="0" cellspacing="0" cellpadding="0" style="font-family: arial;">
                    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%">
                                                    <table width="100%" align="left" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td width="50%" valign="bottom" style="line-height:12px; font-size:9px;">Position:{{$positionData->position_name}}<br><?php if($positionData->color_stitch_count > 0) {?>Colors: {{$positionData->color_stitch_count > 0}}<br><?php }?>{{$positionData->placement_type_name}}<br><?php if($positionData->press_setup_qnty > 0){?>Press Setup @ {{$positionData->press_setup_qnty * $price_grid_data[0]->press_setup}} <br><?php }?><?php if($positionData->screen_fees_qnty > 0){?>Screen Fee @ {{$positionData->screen_fees_qnty * $price_grid_data[0]->screen_fees }}<br><?php }?><?php if($positionData->speciality_qnty > 0) {?>Speciality Ink @ {{$positionData->speciality_qnty * $price_grid_data[0]->specialty}}<?php }?>
                                                            </td>
