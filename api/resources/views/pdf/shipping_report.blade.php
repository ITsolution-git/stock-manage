            ...
            <td style="width:100%">
                ...
                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="2" style="font-family: arial; font-size:10px; border-collapse:collapse;">
                    ...
                    <tr>
                        ...
                        <td height="10" style="border:1px solid #000; text-align:center; font-size:9px;">&nbsp;&nbsp;{{$other_data['total_product_qnty']}}</td>
                    </tr>
                </table>
                ...
                <table width="100%" align="left" border="0" cellspacing="0" cellpadding="0" style="font-family: arial; font-size:12px; border-collapse:collapse; font-weight:bold;">
                    <tr>
                        <td style="line-height:20px;">Shipment # {{$shipping->id}}</td>
                    </tr>
                </table>
                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="font-family: arial; font-size:10px; border-collapse:collapse;">
                    <tr>
                    ...
                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" style="width:80%; height:100px; font-size:10px;">
                                        <table width="100%" align="left" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <span><strong>{{$shipping->main_name}}</strong></span><br />
                        ...
                        <td height="15">
                            <table>
                                ...
                                @foreach ($shipping->shipping_boxes as $box)
                        ...
                        <td height="15">
                            <table>
                                <tr>
                                    <td width="100%" height="15" style="font-weight:bold; text-align:left;">Ship Via: {{$shipping->shipping_type}}</td>
                                </tr>
                                <tr>
                ...
                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="2" style="font-family: arial; font-size:10px; border-collapse:collapse;">
                    ...
                    <tr>
                        ...
                        <td height="10" style="border:1px solid #000; text-align:center; font-size:9px; line-height:20px;">&nbsp;&nbsp;{{$shipping->other_data['total_qnty']}}</td>
                    </tr>
                </table>
                <table width="100%" align="left" border="0" cellspacing="0" cellpadding="0">
                    <tr>
