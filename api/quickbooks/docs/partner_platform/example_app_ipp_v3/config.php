...
$quickbooks_oauth_url = 'http://localhost/stokkup/api/quickbooks/docs/partner_platform/example_app_ipp_v3/oauth.php';

// This is the URL to forward the user to after they have connected to IPP/IDS via OAuth
$quickbooks_success_url = 'http://localhost/stokkup/api/quickbooks/docs/partner_platform/example_app_ipp_v3/success.php';

// This is the menu URL script 
$quickbooks_menu_url = 'http://localhost/stokkup/api/quickbooks/docs/partner_platform/example_app_ipp_v3/menu.php';
